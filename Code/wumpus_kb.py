...
def axiom_generator_percept_sentence(t, tvec):
    ...
    pros = []
    fluents_perc = proposition_bases_perceptual_fluents
    for index, val in enumerate(tvec, start=0):			#Adding a counter to boolean vector tvec
        perFluents = ''
        if not val:
            perFluents = '~'					#NOT operator
        pros.append(perFluents + fluents_perc[index] + str(t))
    axiom_str = '&'.join(pros)
...
def axiom_generator_pits_and_breezes(x, y, xmin, xmax, ymin, ymax):
    ...
    pits_list = []
    for (xval, yval) in [(x-1, y), (x+1,y), (x,y), (x,y-1), (x,y+1)]:			#Valid breezy locations (including same as well as neighbouring locations)
        if xval >= xmin and xval <= xmax and yval >= ymin and yval <= ymax:
            pits_list.append(pit_str(xval, yval))
    axiom_str += '|'.join(pits_list) + ')'
...
def axiom_generator_wumpus_and_stench(x, y, xmin, xmax, ymin, ymax):
    ...
    wumpi_list = []
    for (xval, yval) in [(x-1, y), (x+1,y), (x,y), (x,y-1), (x,y+1)]:			#Valid smelly locations (including same as well as neighbouring locations)
        if xval >= xmin and xval <= xmax and yval >= ymin and yval <= ymax:
            wumpi_list.append(wumpus_str(xval, yval))
    axiom_str += '|'.join(wumpi_list) + ')'
...
def axiom_generator_at_least_one_wumpus(xmin, xmax, ymin, ymax):
    ...
    minOneLoc = []
    [minOneLoc.append(wumpus_str(x,y)) for x in range(xmin, xmax+1) for y in range(ymin, ymax+1)]
    axiom_str += '|'.join(minOneLoc)
            ...
            for xval in range(xmin, xmax+1):
                for yval in range(ymin, ymax+1):
                    if xval == x and yval == y:
                        ...
                        notWumpus_str.append('(' + axioms + '|' + '~' + wumpus_str(xval,yval) + ')')
            maxOneLoc.append('(' + ' & '.join(notWumpus_str) +')')
    axiom_str += '&'.join(set(maxOneLoc)) + ')'
...
def axiom_generator_only_in_one_location(xi, yi, xmin, xmax, ymin, ymax, t = 0):
    ...
    for x in range(xmin, xmax+1):
        for y in range(ymin, ymax+1):
            currLoc.append(state_loc_str(x, y, t)) if x == xi and y == yi else currLoc.append('~' + state_loc_str(x, y, t))
    axiom_str += '&'.join(currLoc)
...
def axiom_generator_only_one_heading(heading = 'north', t = 0):
    ...
    for direction in headings:
        heading_list.append('Heading' + direction + str(t)) if direction.upper() == heading.upper() else heading_list.append('~Heading' + direction + str(t))
    axiom_str += '&'.join(heading_list)
...
def axiom_generator_location_OK(x, y, t):
    ...
    axiom_str += state_OK_str(x,y,t) + '<=>' +  '(' + '~' + pit_str(x,y) + '&' + '(' + wumpus_str(x,y) + '==>' + '~' + state_wumpus_alive_str(t) + ')' + ')'
...
def axiom_generator_at_location_ssa(t, x, y, xmin, xmax, ymin, ymax):
    ...
    agentLoc = []
    if x-1 >= xmin and x-1 <= xmax and y >= ymin and y <= ymax:
        agentLoc.append(state_loc_str(x-1,y,t))
    if x+1 >= xmin and x+1 <= xmax and y >= ymin and y <= ymax:
        agentLoc.append(state_loc_str(x+1,y,t))
    if x >= xmin and x <= xmax and y-1 >= ymin and y-1 <= ymax:
        agentLoc.append(state_loc_str(x,y-1,t))
    if x >= xmin and x <= xmax and y+1 >= ymin and y+1 <= ymax:
        agentLoc.append(state_loc_str(x,y+1,t))
    axiom_str += '(' + '|'.join(agentLoc) + ')' + '&' + action_forward_str(t) + ')' + '|' + '(' + state_loc_str(x,y,t) + '&' + '~' + action_forward_str(t) + ')' + ')'
...
def axiom_generator_heading_north_ssa(t):
    ...
    axiom_str += state_heading_north_str(t+1) + '<=>' + '(' + '(' + state_heading_north_str(t) + '&' + '~' + action_turn_right_str(t) + '&' + '~' + action_turn_left_str(t) + ')' + '|' + '(' + state_heading_east_str(t) + '&' + action_turn_left_str(t) + ')' + '|' + '(' + state_heading_west_str(t) + '&' + action_turn_right_str(t) + ')' + ')'
...
def axiom_generator_heading_east_ssa(t):
    ...
    axiom_str += state_heading_east_str(t+1) + '<=>' + '(' + '(' + state_heading_east_str(t) + '&' + '~' + action_turn_right_str(t) + '&' + '~' + action_turn_left_str(t) + ')' + '|' + '(' + state_heading_south_str(t) + '&' + action_turn_left_str(t) + ')' + '|' + '(' + state_heading_north_str(t) + '&' + action_turn_right_str(t) + ')' + ')'
...
def axiom_generator_heading_south_ssa(t):
    ...
    axiom_str += state_heading_south_str(t+1) + '<=>' + '(' + '(' + state_heading_south_str(t) + '&' + '~' + action_turn_right_str(t) + '&' + '~' + action_turn_left_str(t) + ')' + '|' + '(' + state_heading_west_str(t) + '&' + action_turn_left_str(t) + ')' + '|' + '(' + state_heading_east_str(t) + '&' + action_turn_right_str(t) + ')' + ')'
...
def axiom_generator_heading_west_ssa(t):
    ...
    axiom_str += state_heading_west_str(t+1) + '<=>' + '(' + '(' + state_heading_west_str(t) + '&' + '~' + action_turn_right_str(t) + '&' + '~' + action_turn_left_str(t) + ')' + '|' + '(' + state_heading_north_str(t) + '&' + action_turn_left_str(t) + ')' + '|' + '(' + state_heading_south_str(t) + '&' + action_turn_right_str(t) + ')' + ')'
...
def axiom_generator_heading_only_north(t):
    ...
    axiom_str += state_heading_north_str(t) + '<=>' + '(' + '~' + state_heading_east_str(t) + '&' + '~' + state_heading_south_str(t) + '&' + '~' + state_heading_west_str(t) + ')'
...
def axiom_generator_heading_only_south(t):
    ...
    axiom_str += state_heading_south_str(t) + '<=>' + '(' + '~' + state_heading_north_str(t) + '&' + '~' + state_heading_east_str(t) + '&' + '~' + state_heading_west_str(t) + ')'
...
def axiom_generator_heading_only_west(t):
    ...
    axiom_str += state_heading_west_str(t) + '<=>' + '(' + '~' + state_heading_north_str(t) + '&' + '~' + state_heading_east_str(t) + '&' + '~' + state_heading_south_str(t) + ')'
...
def axiom_generator_only_one_action_axioms(t):
    ...
    singleActions = []
    for index, pbAct in enumerate(proposition_bases_actions):
        actions = pbAct + str(t) + '<=>' + '('
        otherActions = []
        [otherActions.append('~' + otherPbAct + str(t)) for i, otherPbAct in enumerate(proposition_bases_actions) if index != i]  #Adding counter to proposition_bases_actions
        actions += '&'.join(otherActions) + ')'
        singleActions.append('(' + actions + ')')
    axiom_str += '&'.join(singleActions)
